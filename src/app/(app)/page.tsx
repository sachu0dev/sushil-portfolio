    ...
    <div className="relative h-full z-20 flex flex-col  items-center text-white">
      ...
      >
        <div className="flex flex-col mb-10 xl:mb-0 justify-center items-center ">
          <div className="flex space-x-10  items-center md:pr-16 xl:pr-32  sm:mb-2 xl:mb-14">
          ...
          <div className="flex relative space-x-10 transform items-center">
            <motion.div
        ...
        <div className="flex justify-between flex-col-reverse xl:flex-row mt-0 xl:mt-[200px]">
          ...
          <motion.div
            className="flex space-x-2 items-center mt-20 xl:mt-0 pl-16 md:pl-0"
