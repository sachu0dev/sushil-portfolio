...
const projects: Projects[] = [
  {
    ...
    description:
      "Create an anonymous feedback platform using Next.js and MongoDB, fostering open, honest communication within teams or communities by enabling users to share thoughts and suggestions without revealing their identity.",
    ...
    <>
      {projects.map((project, index) => {
        return (
          <div
            key={project.num}
            className={`flex flex-col xl:flex-row gap-4 text-white mb-20 ${
              ...
              <div className="flex space-x-8">
                <div className="flex-1">
                  ...
                  <p className="text-white/60 text-lg">
                    Developed a full-stack blog platform with React, TypeScript,
                    and Cloudflare
                  </p>
                </div>
