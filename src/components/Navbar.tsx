...
const Navbar = () => {
  ...
  return (
    <>
      {/* mobile */}
      <motion.div
        className={`flex flex-col xl:hidden relative z-20  justify-between items-center rounded-2xl mx-10 lg:mx-32 xl:mx-64 my-6  ${
          ...
          >
            <Link href="/about">
              <div className="cursor-pointer w-full h-[70px] flex justify-start items-center  border-b-[1px] px-8 border-white/10">
                <span className="text-left w-full ">ABOUT</span>
              </div>
            </Link>
            <Link href="mailto:sushil.dev.in@gmail.com">
              <div className="cursor-pointer w-full h-[70px] flex justify-start items-center  border-b-[1px] px-8 border-white/10">
                <span className="text-left w-full ">CONTACT ME</span>
              </div>
            </Link>
            <Link
              target="_blank"
            ...
            >
              <div className="cursor-pointer w-full h-[70px] flex justify-start items-center   px-8">
                <span className="text-left w-full ">MY CV</span>
              </div>
            </Link>
          </motion.div>
        )}
